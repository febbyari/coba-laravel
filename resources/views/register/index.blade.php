        ...
        <main class="form-registration">
            ...
            <form action="/register" method="POST">
              ...
              <div class="form-floating">
                <input required value="{{ old('name') }}" value="{{ old('name') }}" type="text" name="name" class="form-control rounded-top @error('name') is-invalid @enderror" id="name" placeholder="Name..">
